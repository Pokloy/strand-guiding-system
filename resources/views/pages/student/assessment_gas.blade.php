...
@section('page_title', 'GAS Assessment')
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h2><span class="text-info">GAS</span> Strand Assessment</h2>
        ...
        <div class="row mt-4">
            <div class="col-sm-12">
                ...
                <div class="card cardManual pt-4 pb-4 px-3" style="border-left: 4px solid #17a2b8">
                    <div class="card-body">
                        <?php
                            echo "<input type='hidden' value='".$gas_questions->count()."' id='txt_q_totalcount' />"; 
                            $count = 0; 
