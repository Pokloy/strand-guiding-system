...
@section('page_title', 'STEM Assessment')
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h2><span class="text-warning">STEM</span> Strand Assessment</h2>
        ...
        <div class="row mt-4">
            <div class="col-sm-12">
                ...
                <div class="card cardManual pt-4 pb-4 px-3" style="border-left: 4px solid #ffc107">
                    <div class="card-body">
                        <?php
                            echo "<input type='hidden' value='".$stem_questions->count()."' id='txt_q_totalcount' />"; 
                            $count = 0;
