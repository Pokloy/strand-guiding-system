...
@section('page_title', 'ABM Assessment')
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h2><span class="text-danger">ABM</span> Strand Assessment</h2>
        ...
        <div class="row mt-4">
            <div class="col-sm-12">
                ...
                <div class="card cardManual pt-4 pb-4 px-3" style="border-left: 4px solid #dc3545">
                    <div class="card-body">
                        <?php
                            echo "<input type='hidden' value='".$abm_questions->count()."' id='txt_q_totalcount' />"; 
                            $count = 0; 
